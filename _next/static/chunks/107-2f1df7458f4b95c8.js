            ...
            children: [
              ...
              (0, a.jsxs)("div", {
                ...
                children: [
                  (0, a.jsxs)("div", {
                    className:
                      "bg-slate-50 dark:bg-green-950 bg-opacity-80 dark:bg-opacity-30 rounded border border-slate-300 dark:border-green-900 flex flex-col space-y-8 3xl:space-y-16 py-5 3xl:py-8 px-4 3xl:px-6",
                    children: [
                      (0, a.jsx)("span", {
                        className: es,
                        children: "My Rewards",
                            ...
                            children: [
                              (0, a.jsx)("div", {
                                ...
                                children: (0, a.jsx)("button", {
                                  disabled: !1,
                                  className:
                                    "w-full bg-green-800 hover:bg-green-700 dark:bg-green-800 dark:hover:bg-green-700 rounded flex items-center justify-center space-x-1 py-2 sm:py-2 px-2 sm:px-1",
                                  onClick: () => {
                                    call_claim_rewards();
                                  },
                                  children: (0, a.jsx)("span", {
                                    ...
                                    O && !K
                                      ? (0, a.jsx)("div", {
                                          ...
                                          children: (0, a.jsx)(u.Z, {
                                            ...
                                            noTooltip: !1,
                                            tooltipContent:
                                              "The token price is fetched from the STEP/USDC pool on the Metis network via DIA.",
                                            className: ea,
                                          }),
                                        })
                                      : ee && (0, a.jsx)(m.Z, {}),
                  ...
                  if (!s)
                    try {
                      ...
                      if (n) {
                        ...
                        eP({
                          status: "pending",
                          message: "Waiting for STEP approval",
                          tx_hash: a,
                        }),
                          eT(!0);
                        ...
                        (s = !d),
                          ...
                          s ||
                            eW(
                              o().uniqBy(
                                o().concat(eU, {
                                  message: "Approve STEP successful",
                                  tx_hash: a,
                                }),
                                "tx_hash"
                              )
                    ...
                    try {
                      ...
                      if (a) {
                        ...
                        let i = {
                          ...
                          message: s
                            ? "Failed to stake Step!"
                            : "Stake Step successful!",
                          tx_hash: l,
                        };
                        eq(i),
                      ...
                      try {
                        ...
                        if (l) {
                          ...
                          let i = {
                            status: s ? "failed" : "success",
                            message: s
                              ? "Failed to unstake Step"
                              : "Unstake Step successful",
                            tx_hash: a,
                          };
                          eq(i),
                            s || eW(o().uniqBy(o().concat(eU, i), "tx_hash")),
                        ...
                        "user_rejected" === l)
                          ...
                          ? eq({
                              status: "success",
                              message: "Remove Step successful",
                              tx_hash: "string" == typeof t ? t : void 0,
                            })
                          : eq({
                              status: "failed",
                                ...
                                children: tv
                                  ? Y && eO && ty
                                    ? (0, a.jsxs)(B.Z, {
                                        connectChainId: eL,
                                        className:
                                          "w-full bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 rounded flex items-center justify-center text-white text-base 3xl:text-2xl font-medium space-x-1.5 sm:space-x-2 py-3 sm:py-4 px-2 sm:px-3",
                                        children: [
                                          (0, a.jsxs)("span", {
                                            children: [
                                              tN ? "Reconnect" : "Switch",
                                    ...
                                    ? (0, a.jsx)("button", {
                                        ...
                                        className: "w-full ".concat(
                                          tj || !tv
                                            ...
                                            : "bg-green-600 hover:bg-green-700 dark:bg-green-800 dark:hover:bg-green-900 cursor-pointer text-white",
                                    ...
                                    : (0, a.jsx)(B.Z, {
                                        ...
                                        className:
                                          "w-full bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 rounded text-white text-base 3xl:text-2xl font-medium text-center py-3 sm:py-4 px-2 sm:px-3",
                                        children: (0, a.jsx)("span", {
              ...
              children: [
                (0, a.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, a.jsx)("div", {
                      className:
                        "w-fit bg-green-300 dark:bg-green-900 bg-opacity-100 dark:bg-opacity-50 rounded break-all tracking-tighter text-green-800 dark:text-green-200 text-sm 3xl:text-xl font-medium py-1.5 px-4",
                      children: "$STEP Staking Pool",
                    }),
                  ],
                }),
                (0, a.jsxs)("div", {
