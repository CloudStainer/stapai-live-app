                  ...
                  (e1 ||
                    ...
                    ? e1
                      ? (0, a.jsxs)(L.Z, {
                          ...
                          className:
                            "w-full bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 rounded flex items-center justify-center text-white text-base font-medium space-x-1.5 sm:space-x-2 py-3 sm:py-4 px-2 sm:px-3",
                          children: [
                            (0, a.jsxs)("span", {
                                    ...
                                    children: [
                                      ...
                                      "failed" === s
                                        ...
                                        ? (0, a.jsx)("button", {
                                            onClick: () => reset(),
                                            className:
                                              "bg-green-500 dark:bg-green-400 rounded-full flex items-center justify-center text-white p-1",
                                            children: (0, a.jsx)(y.FU5, {
                                              size: 14,
                                            }),
                                          })
                    ...
                    : (0, a.jsx)(L.Z, {
                        ...
                        className:
                          "w-full bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 rounded text-white text-base font-medium text-center sm:space-x-2 py-3 sm:py-4 px-2 sm:px-3",
                        children: (0, a.jsx)("span", {
                                  ...
                                  children: [
                                    ...
                                    (e$ || (0, T.hj)(tU))
                                      ...
                                      : (0, a.jsx)(L.Z, {
                                          ...
                                          buttonConnectTitle: "Connect Wallet",
                                          className:
                                            "w-full px-2 py-3 text-base font-medium text-center text-white bg-blue-500 rounded hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 3xl:text-2xl sm:py-4 sm:px-3",
                                          children: (0, a.jsx)("span", {
                                            children: "Connect Wallet",
                                          }),
                                        }),
